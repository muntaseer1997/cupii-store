...
'kinder': { name: 'Kinder Bueno', price: 130, emoji: '🍪', imgUrl: 'Kinder.png', desc: 'Crispy wafer with hazelnut filling' },
'toblerone': { name: 'Toblerone Chocolate', price: 300, emoji: '😋', imgUrl: 'Toblerone.png', desc: 'Nougat and almonds chocolate bar weight: 43g ' },
...
'macgold': { name: 'Mac Gold', price: 1200, emoji: '✨', imgUrl: 'macgold.png', desc: 'Rich, aromatic premium instant coffee coffee weight: 190gm' },
...
'nescafe-gold': { name: 'Nescafé Gold', price: 1500, emoji: '👑', imgUrl: 'nescafe-gold.png', desc: 'Premium blend with smooth taste' },
'davidoff': { name: 'Davidoff Rich Aroma', price: 940, emoji: '🏆', imgUrl: 'davidoff.png', desc: 'Swiss premium coffee with rich flavor' },
'jacobs': { name: 'Jacobs Gold', price: 1000, emoji: '🌟', imgUrl: 'jacobsg.png', desc: 'Premium instant coffee, smooth and bold' },
'davidoff-fine': { name: 'Davidoff Fine Aroma', price: 940, emoji: '💎', imgUrl: 'davidoff-fine.png', desc: 'Delicate aroma with refined taste' },
'jacobs-Monarch': { name: 'Jacobs Monarch', price: 1000, emoji: '☕', imgUrl: 'jacobsm.png', desc: 'Royal blend of premium arabica coffee' },
'davidoff-espresso': { name: 'Davidoff Espresso', price: 940, emoji: '😋', imgUrl: 'davidoff-espresso.png', desc: 'Strong espresso style instant coffee' },
'cadbury': { name: 'Cadbury Milk Chocolate', price: 1500, emoji: '🍪', imgUrl: 'cadbury.png', desc: 'Premium British milk chocolate' },
...
'toblerone-pack': { name: 'Toblerone Pack', price: 600, emoji: '🥃', imgUrl: 'toblerone-pack.png', desc: 'Swiss triangle chocolate with nougat' },
'kinder-bueno': { name: 'Kinder Bueno', price: 640, emoji: '🍸', imgUrl: 'kinder-bueno.png', desc: 'Wafer coated with milk and hazelnut' },
'cadbury-silk': { name: 'Cadbury Dairy Milk Silk Bubbly', price: 420, emoji: '🍹', imgUrl: 'cadbury-silk.png', desc: 'Soft bubbly milk chocolate' },
'nutella-ferrero': { name: 'Nutella Ferrero', price: 680, emoji: '🎂', imgUrl: 'nutella-ferrero.png', desc: 'Hazelnut and cocoa chocolate spread' },
