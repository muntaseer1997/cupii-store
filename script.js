...
'pocky': { name: 'Pocky Chocolate', price: 300, emoji: '🍰', imgUrl: 'Pocky.png', desc: 'Chocolate biscuit sticks treat' },
'hershey-kisses': { name: 'Hershey\'s Kisses Milk Chocolate', price: 20, emoji: '🟫', imgUrl: 'hershey.png', desc: 'Classic milk chocolate kisses' },
'kinder': { name: 'Kinder Bueno', price: 130, emoji: '🍪', imgUrl: 'Kinder.png', desc: 'Crispy wafer with hazelnut filling' },
'toblerone': { name: 'Toblerone Chocolate', price: 300, emoji: '😋', imgUrl: 'Toblerone.png', desc: 'Nougat and almonds chocolate bar' },
'galaxy-smooth': { name: 'Galaxy Smooth Milk', price: 280, emoji: '🧁', imgUrl: 'galaxy-smooth.png', desc: 'Smooth milk chocolate' },
'kitkat-chocolate': { name: 'Kitkat chocolate Box', price: 300, emoji: '🍩', imgUrl: 'kitkat-chocolate.png', desc: 'Crispy wafer chocolate box' },
'hershey-kisses-cookies': { name: 'Hershey\'s Kisses Cookies & Cream', price: 20, emoji: '🍨', imgUrl: 'hershey-hershey.png', desc: 'Chocolate with cookies and cream' },
'Snickers': { name: 'Snickers Chocolate', price: 130, emoji: '🍦', imgUrl: 'Snickers.png', desc: 'Peanuts, nougat and caramel chocolate' },
'cadbury-drinking': { name: 'Cadbury Drinking Chocolate', price: 300, emoji: '😋', imgUrl: 'cadbury-drinking.png', desc: 'Premium chocolate drink mix' },
